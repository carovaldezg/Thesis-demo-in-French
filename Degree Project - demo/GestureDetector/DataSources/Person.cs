...
namespace GestureDetector.DataSources
{
    ...
    public class Person
    {
        ...
        private SwipeRightToLeftChecker swiperight_to_left;
        ...
        public event EventHandler<GestureEventArgs> OnSwipeRightToLeft;
        public event EventHandler<GestureEventArgs> OnSwipeLeftoRight;
        public event EventHandler<GestureEventArgs> OnSwipeLeft;
