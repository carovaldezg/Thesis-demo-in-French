    ...
    public class GestureChecker
    {
        ...
        protected virtual void FireSucessful(Object sender, GestureEventArgs e)
        {
            if (_p != null)
            {
                ...
                reiniciarReconocedorDeGestosKinect();
        }

        private void reiniciarReconocedorDeGestosKinect()
        {
            test.MainWindow.reconocedorgestos.Stop();
            test.MainWindow.reconocedorgestos.StartReconocimiento();
        }
